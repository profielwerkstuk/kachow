...
export class FancyVisualiser extends Visualiser {
	...
	drawSquares = () => {
		this.grassImage.src = "https://media.istockphoto.com/id/474672896/photo/grass-field.jpg?s=612x612&w=0&k=20&c=4DCg7OH6vd9eJYQq1ysujMbgYi2bF-0ff_l8Mx3OOzg=";
		...
		for (let i = 0; i < this.Simulation.gridSize[0]; i++) {
			for (let j = 0; j < this.Simulation.gridSize[1]; j++) {
				...
				this.ctx.drawImage(
					...
					0,
					0,
					this.grassImage.width,
					this.grassImage.height,
					xCoord,
					yCoord,
	...
	update = (Cars: { CarInstance: Car, genome: Genome }[]) => {
		this.carImage.src = "https://cdn.discordapp.com/attachments/926193286278950993/1089557223878967386/image.png";
		// # Clear the canvas
